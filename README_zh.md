...
**调用 claimReward 函数：**  
- 从您的符合条件的钱包中调用 claimReward 函数，需要传入`uint256`参数`tokenId`（对应于您所持有NFT的`tokenId`）。  
...
## 重要信息
⚠️安全提醒⚠️
- 请认准我们唯一的合约地址(Contract Address) [0x893fA9C14c422338E237A9fAB29Deb17AE5D9C74](https://sepolia.etherscan.io/address/0x893fA9C14c422338E237A9fAB29Deb17AE5D9C74)，并且目前处于测试网阶段该地址在测试网上(Sepolia)，任何其他地址都是冒充或者钓鱼合约，切勿交互！
